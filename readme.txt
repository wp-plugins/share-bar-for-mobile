===Wordpress Mobile Share by errnio===
...
Mobile Share by errnio provides a simple and slick share bar for your mobile website.

== Description ==

The errnio **Mobile Share** plugin for Wordpress enhances mobile sharing with added features for your mobile site, providing added tools to share to facebook, twitter, whatsapp, and email. The bar design dynamically adjusts, according to the operating system and browser in use by the site visitor, offering a natural and native design on iOS or Android.

= Features =
Our main features include the following items:

* **Share** - a bottom bar with share options to Facebook, Twitter, Whatsapp, and Mail. The bar appears on the first scroll event on the page, and remains at the bottom of the screen.
* **Customization** - Add additional site features using errnio’s control panel. Register with us to discover more.


Along with the share bar, the errnio plugin can also add a new revenue and engagement layer to your site. Without adding **ads** or **banners**, errnio can enhance your revenue. Make **more** money from your site with **no more** banners or ads. Register and contact us to find out more.


= How it Works =

The **errnio plugin** reaches out to errnio servers and includes the errnio **gesture recognition code**. The gesture recognition code presents the site search box when a user scrolls down your site, offering an intuitive mobile friendly search experience.


= Advantages =

Make sure to Sign up to our service, after performing the activation, to gain access to:

* Improve social engagement metrics of your mobile site
* Reach "Best of Brand" user experience and bring your site up to par with the best out there.
...
5. You should receive a notification on your dashboard, follow the instructions there.
...
**2.3 New and improved design for errnio settings page and admin notice
**2.2 Update test
**2.1 Version update
**2.0 Version release