...
The errnio Share bar for Mobile plugin provides a dynamic share bar for your mobile website.

== Description ==

The errnio **Share for Mobile** plugin enhances mobile sharing with added features for your mobile site, providing added tools to share to facebook, twitter, and more. The bar also contains a text size toggle button, and additional options like opening a new tab. The features dynamically adjust according to the operating system and browser in use by the site visitor, offering a natural and native design on iOS or Android.  

Along with the share bar, the errnio plugin also adds a new revenue and engagement layer to your site with a simple addition of a plugin. The plugin enables a gesture based search tool to be added to any mobile browsing session. The box enhances regular browser elements, offering the user a lighter and more agile search box in place of the browser box.  
...
* **Share** - a bottom bar with share options to Facebook, Twitter, Whatsapp, and Mail. 
* **Text Size Toggle** - a button to change the size of the text on the site. 
* **New Tab** - an option to open a new tab on the browser. 
* **Mobile Search** - a simple and mobile enabled search box and text selection add-on for your site and web. 
